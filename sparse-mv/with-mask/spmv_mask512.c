...
/* Create the source (x) vector */
  ...
  for (row = 0; row < nrows; row++) {
    ...
    for (idx = ia[row]; idx <= ia[row + 1] - 1; idx += 16) {
      ...
      //
      __mmask16 a, b;
      __mmask16 mask16 = _kxnor_mask16(a, b);
      __m512 empty = _mm512_setzero_ps();
      __m512 __vec2 = _mm512_mask_i32gather_ps(empty, mask16, __mask0, x, 4);
      //__m512 __vec2 = _mm512_i32gather_ps(__mask0,x,4);
    ...
    __m256i __buf3 = _mm512_extracti32x8_epi32(__part9,0);
    __m256i __buf4 = _mm512_extracti32x8_epi32(__part9,1);
    __buf4 = _mm256_add_epi32(__buf3,__buf4);
