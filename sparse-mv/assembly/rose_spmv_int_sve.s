...
// %bb.33:                              //   in Loop: Header=BB2_32 Depth=1
	sub	w14, w12, #1                    // =1
	mov	w13, wzr
	whilelt	p0.s, wzr, w14
.LBB2_34:                               //   Parent Loop BB2_32 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	sxtw	x15, w10
	ld1w	{ z0.s }, p0/z, [x21, x15, lsl #2]
	ld1w	{ z1.s }, p0/z, [x20, x15, lsl #2]
	ld1w	{ z1.s }, p0/z, [x22, z1.s, sxtw #2]
	mul	z1.s, p0/m, z1.s, z0.s
	saddv	d0, p0, z1.s
	whilelt	p0.s, w10, w14
	add	w10, w10, w9
	fmov	x15, d0
	cmp	w10, w12
	add	w13, w13, w15
