...
.LBB2_43:                               # %for.body100.epil
                                        # =>This Inner Loop Header: Depth=1
	vmovdqu64	(%r15,%rdx,4), %zmm1
	vpxor	%xmm2, %xmm2, %xmm2
	kxorw	%k0, %k0, %k1
	vpgatherdd	(%r12,%zmm1,4), %zmm2 {%k1}
	vpmulld	(%rbx,%rdx,4), %zmm2, %zmm1
...
.LBB2_53:                               # %for.body100.1
                                        #   Parent Loop BB2_48 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vmovdqu64	(%r15,%rdi,4), %zmm1
	kxorw	%k0, %k0, %k1
	vpxor	%xmm2, %xmm2, %xmm2
	vpgatherdd	(%r12,%zmm1,4), %zmm2 {%k1}
	vpmulld	(%rbx,%rdi,4), %zmm2, %zmm1
	vpaddd	%zmm0, %zmm1, %zmm0
	addq	$16, %rdi
	cmpq	%rbp, %rdi
	jl	.LBB2_53
